...
function unlockHint(hintNumber) {
    ...
    if (!usedHints.has(hintNumber)) {
        ...
        // Sauvegarder l'état
        localStorage.setItem('challenge4Score', currentChallengeScore);
        localStorage.setItem('usedHints4', JSON.stringify([...usedHints]));
    }
}
...
function submitFlag(event) {
    ...
    const correctFlag = 'FLAG{NETWORK_TRAFFIC}';
        ...
        resultMessage.innerHTML = `
            <div class="success-message">
                ...
                <div class="navigation-buttons mt-3">
                    ...
                    <a href="/challenge/5" class="btn btn-success">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Restaurer l'état
    currentChallengeScore = parseInt(localStorage.getItem('challenge4Score')) || initialScore;
    const usedHintsStored = JSON.parse(localStorage.getItem('usedHints4')) || [];
