...
function unlockHint(hintNumber) {
    ...
    if (!usedHints.has(hintNumber)) {
        ...
        // Sauvegarder l'état
        localStorage.setItem('challenge3Score', currentChallengeScore);
        localStorage.setItem('usedHints3', JSON.stringify([...usedHints]));
    }
}
...
function submitFlag(event) {
    ...
    const correctFlag = 'FLAG{INSPECT_ME}';
        ...
        resultMessage.innerHTML = `
            <div class="success-message">
                ...
                <div class="navigation-buttons mt-3">
                    ...
                    <a href="/challenge/4" class="btn btn-success">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Restaurer l'état
    currentChallengeScore = parseInt(localStorage.getItem('challenge3Score')) || initialScore;
    const usedHintsStored = JSON.parse(localStorage.getItem('usedHints3')) || [];
